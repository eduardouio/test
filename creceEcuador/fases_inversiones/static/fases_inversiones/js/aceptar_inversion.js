...
let OPORTUNIDAD = {}
let RUTA_FASE_2 ="/registro/completa_datos/"
let RUTA_SOLICITUDES ="/solicitudes/";
let RUTA_ACEPTAR_INVERSION = '/registro/aceptar_inversion/'
...
$( document ).ready(function() {
    ...
    let monto = obtener_monto()
    if(id_oportunidad){
        obtenerDetallesOportunidadInversion(id_oportunidad);
        let input_monto_inversion = document.getElementById("input-monto")
        input_monto_inversion.value = monto
    }
...
function guardar_tabla(oportunidad) {
	...
	xhttp.open("POST", RUTA_ACEPTAR_INVERSION, true);
